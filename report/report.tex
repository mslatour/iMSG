...
\begin{enumerate}
    ...
    \item Initialize the set of unseen formula predicates $U$ to the predefined set of all possible predicates of $type(t_i)$
...
\subsubsection{Template sampling}
    ...
    %\item Calculate normalization constant $Z$, $Z = \sum_{r \in G_l'} \left[ \frac{1}{cost(r) \cdot 2 \cdot \left|\left|lhs(r)\right|\right| - 1} \right]$
